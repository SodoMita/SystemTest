...
state.settings.countdown = 1
-- Match start must clear inventories (team directive 2026-08-29)
alpha:get_inventory():add_item("main", ItemStack("sl_modebase:scrap_metal 40"))
...
check(not alpha:get_inventory():contains_item("main", ItemStack("sl_modebase:scrap_metal 40")),
	"inventories cleared at match start")
