...
local abilities = {
    ...
    },
    {
        ...
        name = "Hunger Resist",
        type = "stat",
        icon = "ability_resist_hunger.png",
    ...
    },
    {
        ...
        name = "Poison Resist",
        type = "stat",
        icon = "ability_resist_poison.png",
    ...
    for _, ability in ipairs(abilities) do
        ...
        if x + node_size >= graph_x + 0.7  and x <= graph_x + graph_w and
           y + node_size >= graph_y + 0.7 and y <= graph_y + graph_h - 0.7 then
            ...
            -- Use image_button to display the icon instead of text label
    ...
    for _, ability in ipairs(abilities) do
        if fields["node_" .. ability.id] then
            ...
            local tooltip = string.format("%s | Cost: %d SP | Level: %d/%d", 
                ability.name, ability.cost or 1, current_level, max_level or 1)
            if ability.requires then
