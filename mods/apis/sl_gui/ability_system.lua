...
minetest.register_on_player_receive_fields(function(player, formname, fields)
    if formname ~= "ability_tree" and formname ~= "" and formname ~= "unified_inventory" then
        return
    end
    ...
    if formname == "" or formname == "unified_inventory" then
        ...
        minetest.show_formspec(name, "ability_tree", get_ability_formspec_new(player))
    end
end)
...
minetest.log("action", "[ability_system] System Looting ability graph loaded.")
